...
export async function spc246UseCase(
  document: string,
  typeDocument: "CPF" | "CNPJ",
  insumos: number[],
) {
  const allowedInsumos = new Set([
    18, 49, 5262, 5266, 5241, 5224, 5226, 5227, 5263, 5257, 5260, 5240, 5256,
    5265, 5255, 5264, 5225, 24, 5267, 5261, 5229, 5247, 5245, 5259, 5183, 5268,
  ]);
