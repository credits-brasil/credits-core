...
export async function spc676UseCase(
  document: string,
  typeDocument: "CPF" | "CNPJ",
  insumos: number[],
) {
  const allowedInsumos = new Set([
    18, 5180, 5262, 5266, 5195, 5241, 5224, 5226, 5190, 5239, 5260, 5256, 5265,
    5255, 5097, 5253, 5254, 5264, 5225, 5232, 5261, 5259, 23, 3082, 78, 77,
    5183, 5268,
  ]);
