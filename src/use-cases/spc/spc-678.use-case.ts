...
export async function spc678UseCase(
  document: string,
  typeDocument: "CPF" | "CNPJ",
  insumos: number[],
) {
  const allowedInsumos = new Set([
    18, 5262, 5244, 5178, 5185, 5241, 5226, 5193, 5263, 5257, 5260, 5240, 5265,
    5264, 5179, 5225, 24, 5258, 5186, 5267, 5184, 5261, 5229, 5247, 5245, 5259,
    77, 5183,
  ]);
